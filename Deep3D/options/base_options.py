...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # BFM setting
        parser.add_argument('--cartoon_weight_shape', type=float, default=None, help='Weight for cartoon mean face')
        parser.add_argument('--cartoon_weight_tex', type=float, default=None, help='Weight for cartoon mean face')
