...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--datalist', type=str, default='examples', help='datalist for test images.')
        parser.add_argument('--root', type=str, default='deep3d_data', help='root for data')
