...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--head_only', type=lambda x: (str(x).lower() == 'true'), default=False, help='Only train the head of resnet')
        ...
        parser.add_argument('--epoch_count', type=int, default=None, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
        parser.add_argument('--phase', type=str, default='train', help='train, val, test, etc')
        parser.add_argument('--pretrained_name', type=str, default=None, help='resume training from another checkpoint')
        parser.add_argument('--finetune', type=lambda x: (str(x).lower() == 'true'), default=False, help='Whether to resume training or finetuning')
